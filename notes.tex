...
\begin{itemize}
  ...
  \end{itemize}
  \item what the FUCK are lect 25-6 cooking? about tests for two independent means and proportions. do you just get the t or z scores out of thin air? aka from isle.stat.cmu.edu?
\end{itemize}
