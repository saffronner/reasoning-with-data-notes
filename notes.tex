...
\begin{itemize}
  ...
  \begin{itemize}
    \item sensitivity/statistical significance: low random variation (use a large sample size)
  ...
  \item observational study: subjects decided which treatments to get (eg survey vitamin c usage vs flu symptoms)
  \item experimental study: researchers decide how subjects get treatments (randomized ie random assignment for best results)
\end{itemize}
